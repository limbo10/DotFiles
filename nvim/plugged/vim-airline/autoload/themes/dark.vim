...
" The dark.vim theme:
let s:airline_a_normal   = [ '#f9f5d7' , '#d65d0e' , 17  , 230 ]
let s:airline_b_normal   = [ '#f9f5d7' , '#444444' , 255 , 238 ]
let s:airline_c_normal   = [ '#f9f5d7' , '#202020' , 85  , 234 ]
...
let g:airline#themes#dark#palette.normal_modified = {
      \ 'airline_c': [ '#f9f5d7' , '#1d2d44' , 255     , 53      , ''     ] ,
      \ }


let s:airline_a_insert = [ '#f9f5d7' , '#98971a' , 17  , 45  ]
let s:airline_b_insert = [ '#f9f5d7' , '#444444' , 255 , 27  ]
let s:airline_c_insert = [ '#f9f5d7' , '#202020' , 15  , 17  ]
...
let s:airline_a_visual = [ '#f9f5d7' , '#457b9d' , 232 , 214 ]
let s:airline_b_visual = [ '#f9f5d7' , '#444444' , 232 , 202 ]
let s:airline_c_visual = [ '#f9f5d7' , '#202020' , 15  , 52  ]
...
let g:airline#themes#dark#palette.visual_modified = {
      \ 'airline_c': [ '#f9f5f7' , '#1d2d44' , 255     , 53      , ''     ] ,
      \ }
...
let s:airline_a_commandline = [ '#f9f5f7' , '#0081a7' , 17  , 40 ]
let s:airline_b_commandline = [ '#f9f5f7' , '#444444' , 255 , 238 ]
let s:airline_c_commandline = [ '#f9f5f7' , '#202020' , 85  , 234 ]
...
if get(g:, 'loaded_ctrlp', 0)
  let g:airline#themes#dark#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
        ...
        \ [ '#f9f5f7' , '#875fd7' , 231 , 98  , ''     ],
        \ [ '#5f00af' , '#f9f5f7' , 55  , 231 , 'bold' ])
endif
